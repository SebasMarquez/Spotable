...
class _MenuScreenState extends State<MenuScreen> {
  ...
  static const String restaurantId = "id_cantina"; // Definir como constante para reutilizar
  ...
  Widget _buildMenuGrid() {
    return StreamBuilder<List<MenuItem>>(
      stream: selectedCategory == 'Todos' 
          ...
          : FirebaseService.getMenuItemsByCategory(restaurantId, selectedCategory),
          ...
          return ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CartScreen(restaurantId: restaurantId), // Pasar el restaurantId
                ),
              );
            },
