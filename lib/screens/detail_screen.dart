    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Image.network(
          ...
          fit: BoxFit.cover, // CLAVE: Esto hace que la imagen cubra todo el espacio manteniendo proporción
          width: double.infinity,
        ...
        children: [
          IconButton(
            ...
            style: IconButton.styleFrom(
              backgroundColor: quantity > 1 ? AppColors.primary : Colors.grey[300],
